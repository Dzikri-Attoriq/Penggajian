        ...
        <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-icon">  
                    ...
                    <img src="<?= base_url('assets/'); ?>img/logo.png" alt="" width="50" height="50">
                </div>
                <div class="sidebar-brand-text mx-3">PPU</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <h4 class="font-weight-bold">Penajam Paser Utara</h4>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?= base_url('assets/img/profile/').$this->session->userdata('foto'); ?>">
                            </a>
