        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('admin/PotonganGaji/updateDataAksi'); ?>" method="POST">
                    <input type="hidden" name="id" value="<?= $potGaji['id']; ?>" class="form-control">
                    <div class="row">
                        <div class="col-md-5 mx-auto">
                            <div class="form-group">
                                <label for="potongan" class="pl-1">Jenis Potongan</label>
                                <input type="text" name="potongan" id="potongan" class="form-control" value="<?= $potGaji['potongan']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="jml_potongan" id="jml_potongan" class="form-control" value="<?= $potGaji['jml_potongan']; ?>">
