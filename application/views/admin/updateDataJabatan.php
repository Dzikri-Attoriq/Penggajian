                    ...
                    <div class="row">
                        <div class="col-md-5 mx-auto">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="gaji_pokok" id="gaji_pokok" class="form-control" value="<?= $jabatan['gaji_pokok']; ?>">
                                <?= form_error('gaji_pokok','<small class="text-danger pl-3">','</small>'); ?>
                            </div>

                            <div class="form-group">
                                <label for="tj_transport" class="pl-1">Tunjangan Transportasi</label>
                                <input type="text" name="tj_transport" id="tj_transport" class="form-control" value="<?= $jabatan['tj_transport']; ?>">
                                <?= form_error('tj_transport','<small class="text-danger pl-3">','</small>'); ?>
                            </div>

                            <div class="form-group">
                                <label for="uang_makan" class="pl-1">Uang Makan</label>
                                <input type="text" name="uang_makan" id="uang_makan" class="form-control" value="<?= $jabatan['uang_makan']; ?>">
